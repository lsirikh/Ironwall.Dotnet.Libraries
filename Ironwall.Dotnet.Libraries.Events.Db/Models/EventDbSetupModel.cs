...
namespace Ironwall.Dotnet.Libraries.Events.Db.Models;
/****************************************************************************
   Purpose      :                                                          
   Created By   : GHLee                                                
...
****************************************************************************/
public class EventDbSetupModel : IMariaDbSetupModel
{
    #region - Ctors -
    public EventDbSetupModel()
    {
        
    }
    public EventDbSetupModel(IMariaDbSetupModel model)
    {
