using Ironwall.Dotnet.Libraries.OnvifSolution.Base.Models.Defines;
...
namespace Ironwall.Dotnet.Libraries.OnvifSolution.Base.Models
{
    ...
    public class ConnectionModel : BaseModel, IConnectionModel
    {
        ...
        public ConnectionModel(int id, string deviceName, string userName, string password, string ipAddress, int port, int portOnvif, int portRtsp, bool rtspAuthRequrired, bool isDummy, string dummyOption) : base(id)
        {
